...
<body>
  ...
  <nav class="left max l top-margin">
    ...
    <?php endif; ?>
    <?php if ($_SESSION['user_type'] == 'usuario' or $_SESSION['user_type'] == 'ADM') : ?>
  ...
  <main class="responsive max no-padding">
    ...
    <!-- @Seção com cards -->
    <!-- @Form para restaurantes -->
    <fieldset>
      <form action="/restaurante/restauranteCadastro" method="post">
        <legend>Cadastre um restaurante</legend>
        ...
        <button class="small-round green white-text" type="submit">
          <i>check</i>
          <span>Adicionar</span>
        </button>
      </form>
